...
def plot_background_rates(all_gas_mixtures_2023, all_gas_mixtures_2024):
    ...
    ax.text(0.75, 0.75, text_label, transform=ax.transAxes, verticalalignment='top', horizontalalignment='left', fontsize=15, linespacing=1.5)

    plt.text(18, 3.1+0.03, "GIF++", font0)
    hep.cms.text("Preliminary", fontsize=32)

    plt.savefig(os.path.join('Plots_23v24', "bkg_vs_abs2.png"))
