...
python analyzeNoiseRateRun.py $1 RE2_2_NPD_BARC_8_A
python analyzeNoiseRateRun.py $1 RE2_2_NPD_BARC_8_B
python analyzeNoiseRateRun.py $1 RE2_2_NPD_BARC_8_C
