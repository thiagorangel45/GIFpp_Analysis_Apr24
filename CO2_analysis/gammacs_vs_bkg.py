...
def plot_background_rates(all_gas_mixtures_2023, all_gas_mixtures_2024):
    ...
    ax.set_ylabel('Gamma cluster size', fontproperties='DejaVu Sans', size=20, weight='bold')
    ...
    plt.text(1.7, 2.4 + 0.015, "GIF++", fontdict=font0)
    hep.cms.text("Preliminary", fontsize=32)

    plt.savefig(os.path.join('Plots_23v24', "gammacs_vs_bkg2.png"))

if __name__ == "__main__":
    eff_wp_calc_2023 = read_data('2023_data_atWP_fullscans.csv')
    eff_wp_calc_2024 = read_data('2024_data_atWP_fullscans.csv')
